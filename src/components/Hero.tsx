    ...
    <div className="min-h-screen flex flex-col justify-center items-center text-center relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <motion.div
          ...
          className="flex justify-center items-center gap-4 relative z-10"
        >
          {/* Botón Título */}
          <a
            ...
            className="px-6 py-3 text-lg font-semibold text-white bg-cyan-600 rounded-lg shadow hover:bg-cyan-700 transition transform hover:scale-105"
            style={{
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 py-3 text-lg font-semibold text-white bg-gray-900 rounded-lg shadow hover:bg-gray-800 transition transform hover:scale-105"
            style={{
              boxShadow:
